...
QtObject
{
    ...
    readonly property color originalDarkPrimary: "#73CEFC"
    readonly property color darkPrimary: Qt.darker(originalDarkPrimary, 1.4)
    ...
    readonly property color bg300_2: isLightTheme ? light800 : dark300
    ...
    readonly property int tooltipFontSize: fontSize-1

    readonly property color textColor: bg1000
    readonly property color textColor2: bg700
    readonly property color bgColor: bg100
    readonly property color outlineBorderColor: bg300_2
    ...
    readonly property color placeholderTextColor: bg600
    ...
    readonly property color glowColor: isLightTheme ? dark300 : light500
    readonly property bool useGlow: true
    ...
    readonly property color bottomBarShadowColor: isLightTheme ? "#CC969BA3" : "#CC969BA3"

    readonly property real opacityDisabled: 0.6

    readonly property int mainContentMargins: 12

    readonly property int tagSquareSize: 12

    readonly property color lightSnailOnGradientStart: darkAmber
    readonly property color lightSnailOnGradientEnd: "#F9D876"
    readonly property color darkSnailOnGradientStart: lightSnailOnGradientStart
    readonly property color darkSnailOnGradientEnd: lightSnailOnGradientEnd
    ...
    readonly property color drawerMenuItemTextColor: isLightTheme ? light500 : dark900

    readonly property color baseBgColorInSnailMode: "#FFEBC4"
    readonly property color appTitleBgColor: isLightTheme ? primary : Qt.darker(originalDarkPrimary, 2.5)
    readonly property color appTitleBgColorInSnailMode: isLightTheme ? amber : Qt.darker(baseBgColorInSnailMode, 3)
    readonly property color downloadsListToolbarBgColorInSnailMode: isLightTheme ?
                                                                        baseBgColorInSnailMode :
                                                                        Qt.lighter(baseBgColorInSnailMode, 0.2)

    readonly property color separator: bg300
